                    ...
                    <div class="chose  clearfix">
                        <ul class="chose_item clearfix">
							...
							<#if Session["数据引擎-货源"]==1> <li class="l_side " id="complain"><a href="/datacargo.htm">货源</a></li></#if> 
							  <li class="l_side chose_active" id="user"><a href="/databank.htm">金融</a></li>
                        </ul>
                    </div>
                  <div class="data" >
                      <h3  style="margin-bottom:0;">金融数据</h3 >
                    <div class="data_img">
                    <table width="98%" border="0" cellpadding="0" cellspacing="0">
  <tr>
   <td> <div id="main" align=left style="height:300px;width: 300px;"></div></td>
  <td> <div id="main2" align=right style="height:300px;width: 500px;"></div></td>
  </tr>
 </table>
                    </div>
                  </div>
