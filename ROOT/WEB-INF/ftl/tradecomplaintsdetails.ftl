            ...
            <div class="rside">
                <div class="record">
                    ...
                    <div class="table_3 clearfix">
                        ...
                        <div class="table_m" style="width:250px;">
                        ...
                        <div class="bttn">
                            <button class="back" onclick="undocomplain();">撤销</button>
                            <button class="past" onclick="cancelcomplain();">投诉审核</button>
                        </div>
                    </div>
                    <div class="info">
 ...
 <#if orders.companyInfo.yyzzsfrz == 0 >
  ...
  已认证
   ...
   function undocomplain(){
		$.ajax({  
	        url:"/ajax/undocomplain.htm",  
	        type:"post", 
	        data:{ordersid:'${orders.id}'},
	        dataType:"json",
	        success:function(data) { 
	      		if(data.flag==1){
	      			alert("撤销订单投诉成功!");
	      			window.parent.location.href="/tradecomplaints.htm";
	      		}else{
	      			alert("撤销订单投诉失败!");
	      		}
	        },error:function(data) {  
